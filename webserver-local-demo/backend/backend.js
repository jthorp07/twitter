...
const { authenticateUser } = require('./userauth.js');
...
app.post('/api/login/', async function (req, res) {
    ...
    let success = await authenticateUser(login_token);

    if (success) {
        // Start user's stream
        // TODO: Finish after finishing new twitter funcs
    }
